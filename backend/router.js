...
router.post('/user/reset-password', (req, res, next) => users.ResetPassword.process(req, res, next));
router.post('/user/new-password/:id', (req, res, next) => users.SetNewPassword.process(req, res, next));
